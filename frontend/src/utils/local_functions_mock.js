import patientDetails from '../old files not used/JSON/patient_details_mock.json';
import predictionExplain from '../old files not used/JSON/patient_prediction_explain_mock.json';
// import predictionExplain from './JSON/patient_contributions_DataSet1/patient_1428_explanation.json';
